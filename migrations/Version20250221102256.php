 ...
 */
final class Version20250221102256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE description description VARCHAR(255) DEFAULT NULL, CHANGE date_publication date_publication DATE NOT NULL');
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E6676404F3C FOREIGN KEY (id_author_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_23A0E6676404F3C ON article (id_author_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_23A0E6676404F3C ON article');
        $this->addSql('ALTER TABLE article CHANGE description description LONGTEXT NOT NULL, CHANGE date_publication date_publication DATETIME NOT NULL');
    }
}
